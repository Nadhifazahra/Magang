  ...
  <div class="min-h-full">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="{{ route('beranda') }}" class="rounded-md px-3 py-2 text-sm font-medium text-white bg-gray-900">Beranda</a>
    ...
    <main>
      ...
      <section class="text-center mb-10">
            <img src="img/Logo_PT_KAI.svg.png" alt="PT KAI" class="h-20 mx-auto mb-4">
            <h1 class="text-4xl font-bold mb-2">Selamat Datang di PT KAI DAOP 5</h1>
            <p class="text-gray-600">Sistem Informasi Divisi IT</p>
        </section>

        <section class="mb-10">
            <h2 class="text-2xl font-semibold mb-4">PT KAI DAOP 5</h2>
            ...
            Yang menjadi khas dari Daop ini adalah diputarkannya lagu berjudul Di Tepinya Sungai Serayu di sejumlah stasiun setiap KA datang dan berangkat</p>
        </section>

        <section class="mb-10">
            <h2 class="text-2xl font-semibold mb-4">Divisi IT PT KAI DAOP 5</h2>
            <p class="text-gray-700">
                Divisi IT di PT KAI DAOP 5 bertanggung jawab atas pengelolaan dan pengembangan infrastruktur teknologi informasi yang mendukung operasional kereta api. Divisi ini mencakup berbagai fungsi, mulai dari pengembangan aplikasi hingga keamanan jaringan.
            </p>
        </section>

        <section class="mb-10">
            <h2 class="text-2xl font-semibold mb-4">Struktur Kepegawaian Divisi IT PT KAI DAOP 5</h2>
            <p class="text-gray-700">
                Struktur kepegawaian di Divisi IT PT KAI DAOP 5 terdiri dari berbagai jabatan yang mendukung operasional teknologi informasi. Beberapa posisi kunci meliputi:
            </p>
            <ul class="list-disc list-inside text-gray-700 ml-4">
                <li>Manajer Divisi IT</li>
                <li>Assistant Manager 1</li>
                <li>Assistant Manager 2</li>
                <li>Staf Sistem Informasi</li>
                <li>Staf Sistem Informasi</li>
            </ul>
        </section>
        
        <section class="text-center">
            <a href="{{ route('pengajuan.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
                Daftar Sekarang
            </a>
        </section> 
      </div>
