      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="{{ route('coba.create') }}" class="rounded-md px-3 py-2 text-sm font-medium text-white bg-gray-900">Pengajuan</a>
                <a href="{{ route('coba.index') }}" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Daftar Pengajuan</a>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
        ...
        <div class="md:hidden" id="mobile-menu">
          <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            <a href="{{ route('coba.create') }}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Pengajuan</a>
            <a href="{{ route('coba.index') }}" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Daftar Pengajuan</a>
          </div>
